...
public class CardatabaseApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
        ...
        // 그리고 Car의 생성자에 field를 추가 했기 때문에 오류가 나는 것을 막기위해 owner들을 추가함.
        ...
        // AppUser 더미 데이터 추가
        // 저 위에 보시면 Owner의 경우에는 owner1 / owner2 만들어가지고 ownerRepository에 저장함
        userRepository.save(new AppUser("user", "$2a$12$3hlAdZvFyTg33isgFLb8gOtTNQcTuss7EgU.cx70LiSCYmJQG9CJK", " USER"));
        userRepository.save(new AppUser("admin", "$2a$12$X73MatIzd1Jy91ocdKhZlOnu7ghfwVzPO7awjWgMk9uZdxGyZDIsm", "ADMIN"));
